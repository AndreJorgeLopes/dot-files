...
alias unnistall='sudo apt-get remove -y'
alias shutdown="sudo shutdown -h"
alias space="sudo ncdu"
alias dev="cd $HOME/dev"
alias startDocker="sudo service docker start"
alias ls='exa -lahF --group-directories-first --color=auto --git --icons --no-permissions --no-user'
...
#cd ~
export PATH="$HOME/.local/bin:$HOME/.config/composer/vendor/bin:$HOME/.cargo/bin:$HOME/.yarn/bin:$HOME/.config/yarn/global/node_modules/.bin:$PATH"
